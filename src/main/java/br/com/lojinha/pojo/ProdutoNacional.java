...
public class ProdutoNacional extends Produto implements Favorito {
    ...
    public ProdutoNacional(String marcaInicial, Tamanho tamanhoInicial) {
        // passa as informações para a classe pai: Produto
        super(marcaInicial, tamanhoInicial);
    }

    public double getImpostoNacional() { return this.impostoNacional; }
    public void setImpostoNacional(double novoImpostoNacional) { this.impostoNacional = novoImpostoNacional; }
